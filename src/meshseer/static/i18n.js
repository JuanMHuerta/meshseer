(function () {
  ...
  const EN = Object.freeze({
    ...
    "options.repositoryAria": "Open MeshSeer GitHub repository in a new tab",
  ...
  const ES = Object.freeze({
    ...
    "options.language.english": "English",
    "options.language.spanish": "Español",
    "options.repositoryAria": "Abrir el repositorio de GitHub de MeshSeer en una pestana nueva",
