...
def test_mesh_summary_exposes_heard_nodes_daily_totals(tmp_path, monkeypatch):
    monkeypatch.setattr(
        "meshseer.storage.utc_now",
    ...
    repo.upsert_node(
        NodeRecord(
            ...
            role="CLIENT",
            channel_index=0,
            last_heard_at="2026-04-14T12:00:00Z",
            last_snr=4.0,
            latitude=10.4,
            longitude=-84.3,
            altitude=18.0,
    ...
    repo.upsert_node(
        NodeRecord(
            ...
            role="CLIENT",
            channel_index=0,
            last_heard_at="2026-04-14T12:05:00Z",
            last_snr=3.8,
            latitude=None,
            longitude=None,
            altitude=None,
    ...
    assert summary.json()["nodes"]["mapped"] == 2
    assert summary.json()["nodes"]["daily_totals"] == [
        {"day": "2026-03-30", "total": 1, "mapped": 1},
        {"day": "2026-04-14", "total": 3, "mapped": 2},
    ]
